...
```json
{
  "spec": { "id": "soksak-spec", "version": "0.0.6" },
  "source": {
  ...
  "artifacts": [
    {
      ...
      "format": "tgz",
      "manifest": "spec.json",
      "url": "https://github.com/soksak-ai/soksak-spec/releases/download/v0.0.6/soksak-ai-plugin-spec-0.0.6.tgz",
      "size": 12345,
...
This `soksak-spec@0.0.6` package may still validate `plugin.json`, `sidecar.json`, and runtime
